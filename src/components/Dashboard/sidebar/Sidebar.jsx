...
const Sidebar = () => {
  ...
  const handleLogout = () =>{
    ...
    <>
      ...
      {/* Sidebar */}
      <div
        className={`z-10 mt-12 md:mt-0 md:fixed flex flex-col justify-between overflow-x-hidden bg-gray-100 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform ${
